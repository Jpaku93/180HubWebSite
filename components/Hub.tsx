...
const Hub: React.FC<HubProps> = ({ scrollOffset, onNavigate }) => {
  return (
    <section className="min-h-screen lg:h-screen grid grid-cols-1 lg:grid-cols-2 border-t border-white/10 bg-brand-charcoal overflow-hidden group/section">
      ...
      <div 
        className="h-full p-12 lg:p-24 flex flex-col justify-center relative overflow-hidden tech-reveal delay-200 bg-gradient-to-br from-brand-charcoal via-[#1a1520] to-[#2a1035] group-hover/section:bg-brand-purple/5 transition-colors duration-1000"
      >
        ...
        <div className="relative z-10 max-w-xl">
          <h2 
            className="text-7xl md:text-8xl font-display font-bold leading-[0.85] mb-12 text-white glitch-hover cursor-pointer"
            onClick={onNavigate}
          >
            ONE<br />
            EIGHTY<br />
          ...
          <div className="space-y-6 text-gray-200 text-lg md:text-xl font-light leading-relaxed border-l-4 border-brand-lime pl-8 mb-12 transform transition-all group-hover/section:border-brand-purple duration-500 bg-white/5 p-6 rounded-r-xl backdrop-blur-sm group-hover/section:translate-x-2">
            <p>
